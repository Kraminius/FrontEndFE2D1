		...
		(
			<div className="delivery-form-container">
				...
				<form>
					...
					<CheckBox isChecked={formData.billingAddressDifferent} onChange={handleToggleBillingAddress} name={"billingAddressDifferent"} >
					...
					<hr />
					<CheckBox isChecked={agreeToTerms} onChange={e => setAgreeToTerms(e.target.checked)} name={"agreeToTerms"}>
